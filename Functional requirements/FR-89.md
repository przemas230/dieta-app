...
- **v2** (2026-08-24, Android): Użytkownik przetestował przycisk na żywo
  ...
  też głębszą, ogólniejszą lukę w samym FR-72 — patrz `FR-72.md`'s v2:
  pola płci/aktywności/celu od zawsze pokazywały domyślnie zaznaczoną
  opcję niezależnie od `configured`, w odróżnieniu od pól liczbowych.
  ...
  `FR-72.md`'s v2), `dieta-app-v93`. `./gradlew :logic:test
